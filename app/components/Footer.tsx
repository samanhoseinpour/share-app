...
const footerIcons = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/0xsaman/",
    icon: () => (
  ...
  {
    name: "GitHub",
    href: "https://github.com/samanhoseinpour",
    icon: () => (
      <svg fill="currentColor" viewBox="0 0 24 24" className="size-6">
        <path
          fillRule="evenodd"
    ...
    <footer className="bg-white/10 backdrop-blur-3xl fixed bottom-0 w-full">
      <div className="container mx-auto px-2.5 py-6 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <p className="mt-8 text-center text-sm/6 text-gray-600 md:order-1 md:mt-0">
          &copy; {date.getFullYear()} <Link href="/">Share Application.</Link>{" "}
          All rights reserved.
        </p>
      </div>
    </footer>
